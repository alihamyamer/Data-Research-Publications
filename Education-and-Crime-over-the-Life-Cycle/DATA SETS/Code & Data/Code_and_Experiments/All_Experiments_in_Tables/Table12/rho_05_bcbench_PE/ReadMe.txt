Elasticity value = 2 (PE)

Goal: Partial equilibrium for low elasticity of substitution between high school and college

Folder: goldin-katz_PE_05
...
0		! emmeflag -set=0 if not calibrating cbar, set =1 when calibrating cbar
 -0.944824814796448        !chi_l

  0.381944626569748        !s_alpha
   1.20215797424316        !s_beta
0.50401058673859        !cbarshare - Consumption by inmates while in prison as share of avgwage(1,4) - 0.314d0
-0.191041320562363       !corrind    - correlation between fixed effects of crime and ability, used in copula
